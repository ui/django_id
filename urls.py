...
from core.feeds import AllEntries, ByTag
...
urlpatterns += patterns('',
    ...
    url(r'^oops/$', 'core.views.oops', name='raise_exception'),
    url(r'^quotes/$', 'core.views.quote_list', name='quote_list'),
    url(r'^quotes/(?P<slug>[-\w]+)/$', 'core.views.quote_detail', name='quote_detail'),
    ...
    url(r'^tags/(?P<slug>[-\w]+)/$', 'core.views.tag_detail',
